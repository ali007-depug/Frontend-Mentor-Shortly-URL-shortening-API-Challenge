...
export default function Hero() {
  return (
    <div className="hero flex gap-10 mt-6 pl-dyp max-sm:px-dyp max-sm:flex-col">
      {/* hero text */}
      <section
        className="hero__text lg:mt-10 sm:w-1/2 max-sm:mt-20 max-sm:text-center "
        aria-labelledby="hero-heading hero-description"
      >
        <h1
          id="hero-heading"
          className="hero__title text-p-darkViolet font-extrabold text-balance text-hero-fluid  max-md:max-w-2/3 mb-2 max-sm:mx-auto"
        >
      ...
      <figure>
        ...
        <img
          ...
          alt="Person working at a computer with analytical data visualization"
